var Collaboration = new Class({
    ...
    listenChannel: function(){
        ...
        var pusher = new Pusher('6ce7d993126461d44741');
        ...
        channel.bind('update_event', function(data) {
            ...
            el.morph({height:data.height, width:data.width, left:data.x, top:data.y, zIndex:data.zindex});
            if(data.note)
                el.getElement('p').set('text', data.note);
        }.bind(this));
